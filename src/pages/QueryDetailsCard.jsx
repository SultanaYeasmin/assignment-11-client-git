        ...
        <div className="container mx-auto my-10">
            <div className="flex flex-col md:flex-row mt-5 justify-between gap-10 items-baseline">
                <div className="md:w-[40%] w-full bg-blue-50">
                    ...
                    <p className="card-title text-gray-500 text-[10px] justify-center">{query_date}</p>
                        <div className="flex justify-start gap-5">
                            ...
                            <div >
                                ...
                                <h2 className="card-title text-sm text-gray-600">{user_name}</h2>
                        ...
                        <figure className="h-[100px] flex justify-start">
