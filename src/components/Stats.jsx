...
const Stats = () => {
    return (
        <div className="grid grid-cols-1 md:grid-cols-3 justify-around items-center bg-black text-white  gap-10 py-10 my-20">
            {/* <div className="flex justify-start items-center"> */}
            <div className="flex md:p-5 p-2 flex-col items-center justify-center">
              
               
                    <div className="w-full flex justify-center"> <img src={img11} alt="members"  className="mb-2 lg:w-24 lg:h-24 w-10 h-10 md:w-16 md:h-16 rounded-lg transition-transform duration-300 hover:scale-110" /></div>
            ...
            <div className="flex md:p-5 p-2 flex-col  items-center justify-center">
                    ...
                    <div className="w-full flex justify-center">
                        <img src={img12} alt="queries" className="mb-2 lg:w-24 lg:h-24 w-10 h-10 md:w-16 md:h-16 rounded-lg transition-transform duration-300 hover:scale-110" />
                    </div>
            ...
            <div className="flex md:p-5 p-2 flex-col items-center justify-center ">
                    ...
                    <div className="w-full flex justify-center">
                        <img src={img13} alt="recommendation" className="lg:w-24 lg:h-24 w-10 h-10 md:w-16 md:h-16 mb-2 rounded-lg transition-transform duration-300 hover:scale-110" />
                    </div>
